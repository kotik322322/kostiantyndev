...
import promoImg from '../../../public/prof.png';
  ...
  return (
    <div className="">
      ...
      <motion.div
        ...
        animate={
          active ? { display: 'block', transition: { delay: 1, duration: 1 } } : { display: 'none' }
        }
        ...
        <motion.div
          ...
          <span className="text-base text-[#FCF6F499]">I code beautiful website</span>
        </motion.div>
        ...
        <motion.div
          ...
          <motion.div animate={active ? { opacity: 1, transition: { delay: 2 } } : { opacity: 0 }}>
            <Image
              src={promoImg}
